...
function travel_scripts() {
	...
	wp_enqueue_style( 'travel-style-my', get_template_directory_uri() . '/layouts/styles.min.css' );
	...
	wp_enqueue_script( 'scripts', get_template_directory_uri() . '/js/scripts.min.js', array(), '12333', true );
